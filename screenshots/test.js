...
(async () => {
  ...
  await page.goto('https://8080-fadcbeeabebaffffdbadfedcafaafdfd.project.examly.io');
  ...
  await page1.goto('https://8081-fadcbeeabebaffffdbadfedcafaafdfd.project.examly.io');
